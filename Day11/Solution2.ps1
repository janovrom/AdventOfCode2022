class Monkey
{
    [System.Collections.Generic.List[System.Int64]] $items
    [System.Int64] $divisor
    [System.Int64] $testFail
    [System.Int64] $testPass
    [Parameter(Mandatory)]
...
$monkeys[0].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[0].operation = 
{
    param([System.Int64] $x)

    return $x * 17
}

$monkeys[1] = New-Object Monkey
$monkeys[1].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[2].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[3].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[4].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[5].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[6].items = New-Object System.Collections.Generic.List[System.Int64]
...
$monkeys[7].items = New-Object System.Collections.Generic.List[System.Int64]
...
for ($round = 0; $round -lt $rounds; $round++)
{
    for ($i = 0; $i -lt $monkeys.Length; $i++)
    {
        ...
        {
            $new = [System.Int64]($monkey.operation.Invoke($item))[0]
            $new = $new % 9699690
